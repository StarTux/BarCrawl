...
public final class CavetoberNeeds implements Needs {
    private final Map<String, Need> map = new HashMap<>();

    public CavetoberNeeds() {
        for (CavetoberNeed need : CavetoberNeed.values()) {
    ...
    public enum CavetoberNeed implements Need {
